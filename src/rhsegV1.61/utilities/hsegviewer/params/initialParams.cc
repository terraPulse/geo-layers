...
//    cout << endl << "Parameters to be read from file " << param_file << endl << endl;
  ...
  // Read user defined parameters from parameter file until End-of-File reached
    ...
    while (!param_fs.eof())
    {
      ...
      if (line.find("-grey_scale") != string::npos)
      {
        sub_string = process_line(line,false);
        grey_scale_flag = (1 == atoi(sub_string.c_str()));
      }
      ...
      if (line.find("-label_in") != string::npos)
      {
        label_in_file = process_line(line,false);
        label_in_flag = true;
      }
      if (line.find("-ascii_in") != string::npos)
      {
        ascii_in_file = process_line(line,false);
        ascii_in_flag = true;
      }
      if (line.find("-reference1") != string::npos)
      {
        reference1_file = process_line(line,false);
        reference1_flag = true;
      }
      if (line.find("-reference2") != string::npos)
      {
        reference2_file = process_line(line,false);
        reference2_flag = true;
      }
/*
      if (line.find("-reference3") != string::npos)
      {
        reference3_file = process_line(line,false);
...
*/
    ...
    string slash = "/";
#endif
    label_data_file = temp_directory + slash + "LABEL_DATA_" + temp_file_name + ".tif";
    fstream io_file_fs;
    ...
    label_mask_file = temp_directory + slash + "LABEL_MASK_" + temp_file_name + ".tif";
#ifdef THREEDIM
    view_input_image_file = temp_directory + slash + "VIEW_INPUT_IMAGE_" + temp_file_name + ".tif";
    view_mask_image_file = temp_directory + slash + "VIEW_MASK_IMAGE_" + temp_file_name + ".tif";
    view_classes_map_file = temp_directory + slash + "VIEW_CLASSES_MAP_IMAGE_" + temp_file_name + ".tif";
    view_objects_map_file = temp_directory + slash + "VIEW_OBJECTS_MAP_IMAGE_" + temp_file_name + ".tif";
    view_boundary_map_file = temp_directory + slash + "VIEW_BOUNDARY_MAP_IMAGE_" + temp_file_name + ".tif";
#endif
    seg_level_classes_map_file = temp_directory + slash + "SEG_LEVEL_CLASSES_MAP_" + temp_file_name + ".tif";
    seg_level_objects_map_file = temp_directory + slash + "SEG_LEVEL_OBJECTS_MAP_" + temp_file_name + ".tif";
    seg_level_class_mean_file = temp_directory + slash + "SEG_LEVEL_CLASS_MEAN_" + temp_file_name + ".tif";
    seg_level_boundary_map_file = temp_directory + slash + "SEG_LEVEL_BOUNDARY_MAP_" + temp_file_name + ".tif";
    seg_level_class_std_dev_file = temp_directory + slash + "SEG_LEVEL_CLASS_STD_DEV_" + temp_file_name + ".tif";
    seg_level_object_std_dev_file = temp_directory + slash + "SEG_LEVEL_OBJECT_STD_DEV_" + temp_file_name + ".tif";
    seg_level_class_bpratio_file = temp_directory + slash + "SEG_LEVEL_CLASS_BPRATIO_" + temp_file_name + ".tif";
    seg_level_object_bpratio_file = temp_directory + slash + "SEG_LEVEL_OBJECT_BPRATIO_" + temp_file_name + ".tif";
 ...
 void InitialParams::print()
 {
  ...
  // Print input parameters
   ...
   cout << "Output class label map file: " << label_out_file << endl;
   ...
   if (label_in_flag)
     cout << "Input class label map file: " << label_in_file << endl;
   if (ascii_in_flag)
     cout << "Input ASCII class label names list file: " << ascii_in_file << endl;
   if (reference1_flag)
     cout << "Input reference file(1): " << reference1_file << endl;
   if (reference2_flag)
     cout << "Input reference file(2): " << reference2_file << endl;
   if (reference3_flag)
     cout << "Input reference file(3): " << reference3_file << endl;
